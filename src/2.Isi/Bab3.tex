...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{assets/pics/fig_erd_contract.png}}
    \caption{Diagram ERD untuk modul \textit{Contract}}
    \label{fig:erd_contract}
\end{figure}

Gambar \ref{fig:erd_contract} menunjukkan struktur basis data untuk modul \textit{Contract}. Terdapat beberapa tabel utama yang saling berhubungan, yaitu: 
\begin{itemize}
...
Berikut merupakan \textit{flowchart} API \textit{Get All User's Contracts}.
\begin{figure}[H]
    \centering
...
Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Get All User's Contracts}.

\begin{figure}
    \centering
    \fbox{\includegraphics[height=0.4\textheight]{assets/pics/fig_request_get_all_user_contracts.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[height=0.4\textheight]{assets/pics/fig_response_get_all_user_contracts.png}}
    \caption{Contoh \textit{response} API \textit{Get All User's Contracts}}
    \label{fig:response_get_all_user_contracts}
\end{figure}

Gambar \ref{fig:flowchart_get_all_user_contracts} menunjukkan \textit{flowchart} alur sistem API \textit{Get All User's Contracts} yang dimulai dari pengguna mengirimkan permintaan (\textit{request}) ke \textit{endpoint} \texttt{/contract/user} menggunakan metode HTTP \textit{GET} seperti pada Gambar \ref{fig:request_get_all_user_contracts}. Dalam \textit{query parameters} terdapat beberapa variabel yang harus diisi dan dapat diisi untuk memenuhi kebutuhan \textit{pagination} supaya data yang diterima dapat dibatasi. Sistem kemudian memproses permintaan tersebut dengan memeriksa autentikasi pengguna, memeriksa \textit{permission} pengguna dan mengambil data kontrak dari pengguna tersebut. Setelah data berhasil diambil, sistem mengembalikan respons (\textit{response}) kepada pengguna yang berisi daftar kontrak yang dimiliki oleh pengguna tersebut seperti pada Gambar \ref{fig:response_get_all_user_contracts}.

\paragraph*{\textit{Get User's Contract Detail by ID}}
Berikut merupakan \textit{flowchart} API \textit{Get User's Contract Detail by ID}.
\begin{figure}[H]
    \centering
...
Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Get User's Contract Detail by ID}.
...
Gambar \ref{fig:flowchart_get_user_contract_detail_by_id} menunjukkan \textit{flowchart} alur sistem API \textit{Get User's Contract Detail by ID} yang dimulai dari pengguna mengirimkan permintaan (\textit{request}) ke \textit{endpoint} \texttt{/contract/user/:id} menggunakan metode HTTP \textit{GET} seperti pada Gambar \ref{fig:request_get_user_contract_detail_by_id}. Sistem kemudian memproses permintaan tersebut dengan memeriksa autentikasi pengguna, memeriksa \textit{permission} pengguna, serta mengambil data detail kontrak berdasarkan \textit{ID} yang diberikan dari \textit{path parameters}, \texttt{contract\_id}. Setelah data berhasil diambil, sistem mengembalikan respons (\textit{response}) kepada pengguna yang berisi detail kontrak yang diminta seperti pada Gambar \ref{fig:response_get_user_contract_detail_by_id_1}, \ref{fig:response_get_user_contract_detail_by_id_2}, dan \ref{fig:response_get_user_contract_detail_by_id_3}.

\paragraph*{\textit{Approve Contract by ID}}
Berikut merupakan \textit{flowchart} API \textit{Approve Contract by ID}.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.5\textheight]{assets/pics/fig_flowchart_approve_contract_by_id.jpg}}
    \caption{Contoh \textit{response} API \textit{Approve Contract by ID}}
    \label{fig:response_approve_contract_by_id}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Approve Contract by ID}.
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{assets/pics/fig_response_approve_contract_by_id.png}}
    \caption{Contoh \textit{response} API \textit{Approve Contract by ID}}
    \label{fig:response_approve_contract_by_id}
\end{figure}
...
Berikut merupakan \textit{flowchart} API \textit{Terminate Contract by ID}.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.7\textheight]{assets/pics/fig_flowchart_terminate_contract_by_id.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Terminate Contract by ID}}
    \label{fig:flowchart_terminate_contract_by_id}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Terminate Contract by ID}.
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{assets/pics/fig_response_terminate_contract_by_id.png}}
...
Berikut merupakan \textit{flowchart} API \textit{Delete Contract by ID}.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.5\textheight]{assets/pics/fig_flowchart_delete_contract_by_id.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Delete Contract by ID}}
    \label{fig:flowchart_delete_contract_by_id}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Delete Contract by ID}.
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{assets/pics/fig_response_delete_contract_by_id.png}}
...
Berikut merupakan \textit{database diagram} untuk modul \textit{Payroll Item} yang telah dibuat selama pelaksanaan kerja praktik.
...
Gambar \ref{fig:erd_payroll_item} menunjukkan struktur basis data untuk modul \textit{Payroll Item}.
...
Berikut merupakan \textit{flowchart} API \textit{Get All Payroll Item}.
\begin{figure}
    \centering
    \fbox{\includegraphics[height=0.4\textheight]{assets/pics/fig_flowchart_get_all_payroll_items.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Get All Payroll Item}}
    \label{fig:flowchart_get_all_payroll_item}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Get All Payroll Item}.
\begin{figure}
    \centering
...
Berikut merupakan \textit{flowchart} API \textit{Get Payroll Item by ID}.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.7\textheight]{assets/pics/fig_flowchart_get_payroll_item_by_id.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Get Payroll Item by ID}}
    \label{fig:flowchart_get_payroll_item_by_id}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Get Payroll Item by ID}.

\begin{figure}
    \centering
    \fbox{\includegraphics[height=0.4\textheight]{assets/pics/fig_request_get_payroll_item_by_id.png}}
...
Berikut merupakan \textit{flowchart} API \textit{Create Payroll Item}.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.7\textheight]{assets/pics/fig_flowchart_create_payroll_items.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Create Payroll Item}}
    \label{fig:flowchart_create_payroll_item}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Create Payroll Item}.
...
Berikut merupakan \textit{flowchart} API \textit{Update Payroll Item}.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.5\textheight]{assets/pics/fig_flowchart_update_payroll_item_by_id.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Update Payroll Item}}
    \label{fig:flowchart_update_payroll_item}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Update Payroll Item}.
...
Berikut merupakan \textit{flowchart} API \textit{Delete Payroll Item}.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.5\textheight]{assets/pics/fig_flowchart_delete_payroll_item.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Delete Payroll Item}}
    \label{fig:flowchart_delete_payroll_item}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Delete Payroll Item}.
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{assets/pics/fig_response_delete_payroll_item.png}}
...
% ---------------------------------- %
Modul Payslip dibuat untuk mengelola dan menghasilkan slip gaji bagi pegawai berdasarkan kontrak yang telah disepakati, dan beberapa. Modul ini mencakup fitur perhitungan gaji, potongan, dan tunjangan sesuai dengan ketentuan yang berlaku dalam kontrak kerja. Struktur basis data dirancang untuk menyimpan informasi terkait gaji, termasuk rincian pembayaran, periode gaji, serta catatan historis. Modul ini juga menyediakan akses untuk menampilkan slip gaji kepada pegawai secara transparan. Modul Payslip juga merupakan langkah terakhir dari sistem penggajian (\textit{Payroll}) yang terintegrasi dengan modul Contract dan modul lainnya.

\subsubsection{Diagram ERD Modul \textit{Payslip}}
Berikut merupakan \textit{database diagram} untuk modul \textit{Payslip} yang telah dibuat selama pelaksanaan kerja praktik.
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.35\textwidth]{assets/pics/fig_erd_payslip.png}}
    \caption{Diagram ERD untuk modul \textit{Payslip}}
    \label{fig:erd_payslip}
\end{figure}
Gambar \ref{fig:erd_payslip} menunjukkan struktur basis data untuk modul \textit{Payslip}.
...
Berikut merupakan \textit{flowchart} API \textit{Get Payslip Detail}.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.4\textheight]{assets/pics/fig_flowchart_get_payslip_detail.jpg}}
    \caption{\textit{Flowchart} alur sistem API \textit{Get Payslip Detail}}
    \label{fig:flowchart_get_payslip_detail}
\end{figure}

Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Get Payslip Detail}.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.3\textheight]{assets/pics/fig_request_get_payslip_detail.png}}
...
Berikut merupakan \textit{flowchart} API \textit{Save Payslip Detail}.
\begin{figure}[H]
    \centering
...
Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Save Payslip Detail}.
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.95\textheight]{assets/pics/fig_response_save_payslip_detail_1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{assets/pics/fig_response_get_user_payslips_list.png}}
...
Berikut merupakan \textit{flowchart} API \textit{Get User Payslip Detail by ID}.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.5\textheight]{assets/pics/fig_flowchart_get_user_payslip_detail_by_id.jpg}}
...
Berikut merupakan contoh \textit{request} dan \textit{response} untuk API \textit{Get User Payslip Detail by ID}.
...
\begin{itemize}
    \item Beberapa \textit{edge case} tidak teridentifikasi pada tahap pengembangan dan pengujian awal. Akibatnya, ketika sistem telah memasuki tahap produksi, masih ditemukan \textit{bug} yang sebelumnya tidak terdeteksi. Hal ini berpotensi mengganggu stabilitas sistem dan pengalaman pengguna.
