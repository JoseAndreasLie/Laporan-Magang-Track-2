...
Pada gambar \ref{fig:response_delete_payroll_item} menunjukkan contoh \textit{response} untuk API \textit{Delete Payroll Item} yang diterima dari \textit{server}, berisi informasi mengenai keberhasilan penghapusan komponen gaji dengan menampilkan \textit{payroll item ID} dari komponen gaji yang telah dihapus.
\begin{figure}
    \centering
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.95\textheight]{assets/pics/fig_flowchart_get_payslip_detail.jpg}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.7\textheight]{assets/pics/fig_flowchart_get_user_payslip_detail_by_id.jpg}}
