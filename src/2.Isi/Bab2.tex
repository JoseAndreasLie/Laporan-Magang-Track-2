...
Contoh rujukan ke logo perusahaan, lihat Gambar \ref{fig:logo}.

\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.5\linewidth]{assets/pics/fig_logo_UMN.png}}
    \caption{Logo perusahaan XXX}
    \label{fig:logo}
\end{figure}
